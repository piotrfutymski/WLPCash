...
(
	...
	st_instr VARCHAR2(64) NOT NULL CONSTRAINT FK_INSTR_ST_INSTR REFERENCES STOPNIE_INSTRUKTORSKIE(nazwa),
	st_harc VARCHAR2(64) NOT NULL CONSTRAINT FK_INSTR_ST_HARC REFERENCES STOPNIE_HARCERSKIE(nazwa),
...
(
	...
	min_wiek NUMBER(3) NOT NULL,
	max_wiek NUMBER(3) NOT NULL
);
